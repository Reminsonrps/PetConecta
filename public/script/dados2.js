...
/*
  Script de cadastro local de pets.
  Gera IDs, valida entradas e salva os dados no localStorage antes da sincronização com o banco.
*/
// Gera um ID curto e evita duplicatas apenas dentro da lista local deste navegador.
function gerarIdPet() {
...
// Le, valida e persiste localmente os dados do pet antes do redirecionamento.
document
  ...
  .addEventListener("submit", function (event) {
    ...
    // Converte a imagem para Data URL; isso facilita o armazenamento local, mas aumenta seu tamanho.
    ...
    reader.onload = function (e) {
      ...
      camposObrigatorios.forEach((campo) => {
        if (!pet[campo] && pet[campo] !== 0) {
          const input = document.getElementById(
            campo === "localiza" ? "localizacao" : campo,
          );
      ...
      if (!whatsappValido) {
        mostrarErro(
          ...
          "Informe apenas números entre 10 e 13 dígitos.",
        );
        valido = false;
      }
